...
<div id="brett">
  <div id="R1K1ON" class="sub" onclick="limInn(1, this)">${div1HTML || ''}</div>
  <div id="R1K2ON" class="sub" onclick="limInn(2, this)">${div2HTML || ''}</div>
  <div id="R1K3ON" class="sub" onclick="limInn(3, this)">${div3HTML || ''}</div>
  <div id="R2K1ON" class="sub" onclick="limInn(4, this)">${div4HTML || ''}</div>
  <div id="R2K2ON" class="sub" onclick="limInn(5, this)">${div5HTML || ''}</div>
  <div id="R2K3ON" class="sub" onclick="limInn(6, this)">${div6HTML || ''}</div>
  <div id="R3K1ON" class="sub" onclick="limInn(7, this)">${div7HTML || ''}</div>
  <div id="R3K2ON" class="sub" onclick="limInn(8, this)">${div8HTML || ''}</div>
  <div id="R3K3ON" class="sub" onclick="limInn(9, this)">${div9HTML || ''}</div>
</div>
`;
}
...
function velgBilde(nummer, div) {
  ...
  if (nummer == '1'){
    if (css1 == ''){css1 += 'markering ';} 
    else if (!css1.includes('skjult')){css1 = ''}
  } 
  if (nummer == '2'){
    if (css2 == ''){css2 += 'markering ';} 
    else if (!css2.includes('skjult')){css2 = ''}
  }
  if (nummer == '3'){
    if (css3 == ''){css3 += 'markering ';} 
    else if (!css3.includes('skjult')){css3 = ''}
  }
  if (nummer == '4'){
    if (css4 == ''){css4 += 'markering ';} 
    else if (!css4.includes('skjult')){css4 = ''}
  }
  if (nummer == '5'){
    if (css5 == ''){css5 += 'markering ';} 
    else if (!css5.includes('skjult')){css5 = ''}
  }
  if (nummer == '6'){
    if (css6 == ''){css6 += 'markering ';} 
    else if (!css6.includes('skjult')){css6 = ''}
  }
  if (nummer == '7'){
    if (css7 == ''){ css7 += 'markering ';} 
    else if (!css7.includes('skjult')){css7 = ''}
  }
  if (nummer == '8'){
    if (css8 == ''){css8 += 'markering ';} 
    else if (!css8.includes('skjult')){css8 = ''}
  }
  if (nummer == '9'){
    if (css9 == ''){css9 += 'markering ';} 
    else if (!css9.includes('skjult')){css9 = ''}
  }

//Fjerne markering fra de som ikke er skjulte
  if (!css1.includes('skjult') && nummer != '1') {css1 ='';}
  if (!css2.includes('skjult') && nummer != '2') {css2 ='';}
  if (!css3.includes('skjult') && nummer != '3') {css3 ='';}
  if (!css4.includes('skjult') && nummer != '4') {css4 ='';}
  if (!css5.includes('skjult') && nummer != '5') {css5 ='';}
  if (!css6.includes('skjult') && nummer != '6') {css6 ='';}
  if (!css7.includes('skjult') && nummer != '7') {css7 ='';}
  if (!css8.includes('skjult') && nummer != '8') {css8 ='';}
  if (!css9.includes('skjult') && nummer != '9') {css9 ='';}
